...
exec "${sanitized_environment[@]}" \
  ...
  MIANBA_POSTGRES_IMAGE="mianba-postgres:$release_sha" \
  MIANBA_REDIS_IMAGE="mianba-redis:$release_sha" \
  MIANBA_RABBITMQ_IMAGE="mianba-rabbitmq:$release_sha" \
  MIANBA_NGINX_IMAGE="mianba-nginx:$release_sha" \
