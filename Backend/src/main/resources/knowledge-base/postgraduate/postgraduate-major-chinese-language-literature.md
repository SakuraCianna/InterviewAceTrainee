---
id: postgraduate-major-chinese-language-literature
domain: postgraduate
category: major
title: 中国语言文学复试专业能力练习
aliases: 中国语言文学,chinese-language-literature
tags: 复试,专业能力,文本细读、文学史、理论、文献和论证表达
...
## 适用边界
本材料用于 中国语言文学 的代表性专业复试训练，不替代目标院校当年专业目录、参考书目和复试细则。不同院系即使专业名称相同，研究方向和评价方式也可能不同；教育部规定之外的具体要求必须以招生单位官网为准。

## 核心知识与表达
- **知识主线**：围绕文本细读、文学史、理论、文献和论证表达建立概念网络。不能只背定义，要能解释概念之间的因果、层级或约束关系，并指出常见混淆。
...
## 研究与实践问题
专业锚点问题：围绕一组文本差异提出解释，结合版本、语境和理论形成可反驳论证。
