---
id: postgraduate-school-medical-university
domain: postgraduate
category: school
title: 医药类院校代表性复试准备
aliases: 医药类院校,medical-university
tags: 复试,院校类型,专业基础、证据意识、伦理安全、实践规范与持续学习
...
## 核心知识与表达
- **培养定位**：专业基础、证据意识、伦理安全、实践规范与持续学习。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：在证据不完整时说明临床或实验判断、风险沟通和升级边界。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
