---
id: postgraduate-school-research-university
domain: postgraduate
category: school
title: 研究型综合大学代表性复试准备
aliases: 研究型综合大学,research-university
tags: 复试,院校类型,学术潜力、基础理论、研究问题意识与长期学习能力
...
## 核心知识与表达
- **培养定位**：学术潜力、基础理论、研究问题意识与长期学习能力。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：从一个宽泛兴趣收敛出可研究问题，并说明变量、证据和可行的第一步。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
