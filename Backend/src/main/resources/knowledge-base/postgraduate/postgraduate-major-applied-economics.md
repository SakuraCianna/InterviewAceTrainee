---
id: postgraduate-major-applied-economics
domain: postgraduate
category: major
title: 应用经济学复试专业能力练习
aliases: 应用经济学,applied-economics
tags: 复试,专业能力,经济理论、计量方法、政策分析、因果意识和数据
...
## 适用边界
本材料用于 应用经济学 的代表性专业复试训练，不替代目标院校当年专业目录、参考书目和复试细则。不同院系即使专业名称相同，研究方向和评价方式也可能不同；教育部规定之外的具体要求必须以招生单位官网为准。

## 核心知识与表达
- **知识主线**：围绕经济理论、计量方法、政策分析、因果意识和数据建立概念网络。不能只背定义，要能解释概念之间的因果、层级或约束关系，并指出常见混淆。
...
## 研究与实践问题
专业锚点问题：评估一项政策影响时区分相关与因果，选择识别策略并检验平行趋势或工具有效性。
