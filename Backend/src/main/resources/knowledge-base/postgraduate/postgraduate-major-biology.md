---
id: postgraduate-major-biology
domain: postgraduate
category: major
title: 生物学复试专业能力练习
aliases: 生物学,biology
tags: 复试,专业能力,细胞与分子基础、实验设计、数据、文献和生物安全
...
## 适用边界
本材料用于 生物学 的代表性专业复试训练，不替代目标院校当年专业目录、参考书目和复试细则。不同院系即使专业名称相同，研究方向和评价方式也可能不同；教育部规定之外的具体要求必须以招生单位官网为准。

## 核心知识与表达
- **知识主线**：围绕细胞与分子基础、实验设计、数据、文献和生物安全建立概念网络。不能只背定义，要能解释概念之间的因果、层级或约束关系，并指出常见混淆。
...
## 研究与实践问题
专业锚点问题：验证某基因是否影响细胞表型，设置阳性阴性对照、重复、统计分析和救援实验。
