---
id: postgraduate-school-science-engineering-university
domain: postgraduate
category: school
title: 理工类院校代表性复试准备
aliases: 理工类院校,science-engineering-university
tags: 复试,院校类型,数理基础、工程问题拆解、实验或项目证据与技术表达
...
## 核心知识与表达
- **培养定位**：数理基础、工程问题拆解、实验或项目证据与技术表达。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：面对性能、成本和可靠性冲突时建立约束模型并设计验证实验。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
