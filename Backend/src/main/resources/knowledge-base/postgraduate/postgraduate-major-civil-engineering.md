---
id: postgraduate-major-civil-engineering
domain: postgraduate
category: major
title: 土木工程复试专业能力练习
aliases: 土木工程,civil-engineering
tags: 复试,专业能力,结构、材料、施工、风险、安全和全生命周期
...
## 适用边界
本材料用于 土木工程 的代表性专业复试训练，不替代目标院校当年专业目录、参考书目和复试细则。不同院系即使专业名称相同，研究方向和评价方式也可能不同；教育部规定之外的具体要求必须以招生单位官网为准。

## 核心知识与表达
- **知识主线**：围绕结构、材料、施工、风险、安全和全生命周期建立概念网络。不能只背定义，要能解释概念之间的因果、层级或约束关系，并指出常见混淆。
...
## 研究与实践问题
专业锚点问题：在荷载、地质、施工和耐久性不确定条件下比较结构方案并设置安全监测。
