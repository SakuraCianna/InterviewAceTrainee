---
id: postgraduate-school-c9-representative
domain: postgraduate
category: school
title: C9 高校类型代表性复试准备
aliases: C9 高校类型,c9-representative
tags: 复试,院校类型,扎实基础、研究潜力、证据质量与学术表达
school_tier: c9
...
## 核心知识与表达
- **培养定位**：扎实基础、研究潜力、证据质量与学术表达。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：从课程或项目中提炼可证伪问题，并比较方法、资源和失败边界。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
