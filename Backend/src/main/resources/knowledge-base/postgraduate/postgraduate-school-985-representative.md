---
id: postgraduate-school-985-representative
domain: postgraduate
category: school
title: 985 高校类型代表性复试准备
aliases: 985 高校类型,985-representative
tags: 复试,院校类型,专业基础、综合分析、实践证据与学习潜力
school_tier: 985
...
## 核心知识与表达
- **培养定位**：专业基础、综合分析、实践证据与学习潜力。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：围绕真实问题提出多种方案，并说明取舍、验证和复盘。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
