---
id: postgraduate-school-general-undergraduate-representative
domain: postgraduate
category: school
title: 普通本科院校类型代表性复试准备
aliases: 普通本科院校类型,general-undergraduate-representative
tags: 复试,院校类型,基础掌握、真实经历、学习计划与持续改进
school_tier: general-undergraduate
...
## 核心知识与表达
- **培养定位**：基础掌握、真实经历、学习计划与持续改进。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：选择一项薄弱能力，设计三个月可检查进展的学习实践计划。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
