---
id: postgraduate-school-academic-degree-program
domain: postgraduate
category: school
title: 学术学位项目代表性复试准备
aliases: 学术学位项目,academic-degree-program
tags: 复试,院校类型,理论基础、文献意识、研究问题和方法匹配
...
## 核心知识与表达
- **培养定位**：理论基础、文献意识、研究问题和方法匹配。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：从文献分歧识别研究缺口，并论证方法为何能回答问题。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
