---
id: postgraduate-major-psychology
domain: postgraduate
category: major
title: 心理学复试专业能力练习
aliases: 心理学,psychology
tags: 复试,专业能力,基础理论、研究设计、统计、测量、伦理和应用边界
...
## 适用边界
本材料用于 心理学 的代表性专业复试训练，不替代目标院校当年专业目录、参考书目和复试细则。不同院系即使专业名称相同，研究方向和评价方式也可能不同；教育部规定之外的具体要求必须以招生单位官网为准。

## 核心知识与表达
- **知识主线**：围绕基础理论、研究设计、统计、测量、伦理和应用边界建立概念网络。不能只背定义，要能解释概念之间的因果、层级或约束关系，并指出常见混淆。
...
## 研究与实践问题
专业锚点问题：研究压力与表现关系时处理操作化、量表信效度、混杂变量与知情同意。
