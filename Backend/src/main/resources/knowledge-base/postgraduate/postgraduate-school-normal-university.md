---
id: postgraduate-school-normal-university
domain: postgraduate
category: school
title: 师范类院校代表性复试准备
aliases: 师范类院校,normal-university
tags: 复试,院校类型,学科基础、教育理解、表达组织、研究方法与职业伦理
...
## 核心知识与表达
- **培养定位**：学科基础、教育理解、表达组织、研究方法与职业伦理。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：把一个课堂观察转化为可验证的教育研究问题并处理学习者差异。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
