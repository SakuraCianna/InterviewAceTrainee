---
id: postgraduate-school-arts-university
domain: postgraduate
category: school
title: 艺术类院校代表性复试准备
aliases: 艺术类院校,arts-university
tags: 复试,院校类型,作品逻辑、创作过程、审美判断、研究意识与表达
...
## 核心知识与表达
- **培养定位**：作品逻辑、创作过程、审美判断、研究意识与表达。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：从作品意图、媒介选择、受众反馈和迭代说明创作判断。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
