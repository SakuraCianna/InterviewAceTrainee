---
id: postgraduate-school-professional-degree-program
domain: postgraduate
category: school
title: 专业学位项目代表性复试准备
aliases: 专业学位项目,professional-degree-program
tags: 复试,院校类型,真实问题解决、职业素养、项目证据和反思
...
## 核心知识与表达
- **培养定位**：真实问题解决、职业素养、项目证据和反思。回答应把课程基础、项目证据、报考动机和未来计划连成因果链，而不是背诵学校宣传语。
...
## 研究与实践问题
锚点问题：定义一个行业问题的交付物、利益相关方、评价指标和落地风险。进一步说明这个问题为什么适合研究生阶段、你已有何种直接或间接证据、最可能失败在哪里，以及前三个月如何形成可检查的阶段成果。
