...
user default off
user mianba_app on >${password} ~mianba:* &mianba:* -@all +@connection +@read +@write +@transaction +@search +@json +eval +evalsha +scan +info -keys -flushall -flushdb -config -shutdown -module -acl
EOF
